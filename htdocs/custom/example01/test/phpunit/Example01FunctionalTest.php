...
/**
 * \file    test/phpunit/Example01FunctionalTest.php
 * \ingroup example01
 ...
 *
 * @package Testexample01
 */
class Example01FunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	private static $module_id = 2500000; // TODO: autodetect?
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modExample01')->click();
		} else {
			// Disable the module
			$this->byHref('modExample01')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/example01/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('example01/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/example01/admin/about.php');
		$this->authenticate();
		return $this->assertContains('example01/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('example01widget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modExample01_Example01Triggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modExample01_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
