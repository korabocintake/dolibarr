...
/**
 *   	\file       svelteclientif_list.php
 *		\ingroup    svelteclientif
 *		\brief      List page for svelteclientif
 */
...
require_once __DIR__.'/class/svelteclientif.class.php';
...
if ($enablepermissioncheck) {
	...
	$permissiontoadd = $user->hasRight('svelteclientif', 'svelteclientif', 'write');
	$permissiontodelete = $user->hasRight('svelteclientif', 'svelteclientif', 'delete');
} else {
	$permissiontoread = 1;
	$permissiontoadd = 1;
...
if (!isModEnabled("svelteclientif")) {
	accessforbidden('Module svelteclientif not enabled');
}
...
if (empty($reshook)) {
	...
	// Mass actions
	$objectclass = 'SvelteClientIf';
	$objectlabel = 'SvelteClientIf';
	$uploaddir = $conf->svelteclientif->dir_output;
...
$title = $langs->trans("SvelteClientIfs");
//$help_url = "EN:Module_SvelteClientIf|FR:Module_SvelteClientIf_FR|ES:Módulo_SvelteClientIf";
$help_url = '';
$morejs = array();
$morecss = array();
...
if ($num == 1 && !getDolGlobalInt('MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE') && $search_all && !$page) {
	...
	$id = $obj->rowid;
	header("Location: ".dol_buildpath('/svelteclientif/svelteclientif_card.php', 1).'?id='.((int) $id));
	exit;
}
...
$newcardbutton .= dolGetButtonTitle($langs->trans('New'), '', 'fa fa-plus-circle', dol_buildpath('/svelteclientif/svelteclientif_card.php', 1).'?action=create&backtopage='.urlencode($_SERVER['PHP_SELF']), '', $permissiontoadd);

print_barre_liste($title, $page, $_SERVER["PHP_SELF"], $param, $sortfield, $sortorder, $massactionbutton, $num, $nbtotalofrecords, 'object_'.$object->picto, 0, $newcardbutton, '', $limit, 0, 0, 1);

// Add code for pre mass action (confirmation or email presend form)
$topicmail = "SendSvelteClientIfRef";
$modelmail = "svelteclientif";
$objecttmp = new SvelteClientIf($db);
