...
/**
 * \file    test/phpunit/SvelteClientIfFunctionalTest.php
...
/**
 * Class SvelteClientIfFunctionalTest
 *
 ...
 *
 * @package Testsvelteclientif
 */
class SvelteClientIfFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modSvelteClientIf')->click();
		} else {
			// Disable the module
			$this->byHref('modSvelteClientIf')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/svelteclientif/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('svelteclientif/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/svelteclientif/admin/about.php');
		$this->authenticate();
		return $this->assertContains('svelteclientif/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('svelteclientifwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modSvelteClientIf_SvelteClientIfTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modSvelteClientIf_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
