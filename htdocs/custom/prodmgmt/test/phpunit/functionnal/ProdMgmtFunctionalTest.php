...
/**
 * \file    test/phpunit/ProdMgmtFunctionalTest.php
 * \ingroup prodmgmt
 ...
 *
 * @package Testprodmgmt
 */
class ProdMgmtFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	private static $module_id = 700000; // TODO: autodetect?
	...
	{
		$this->url('/custom/prodmgmt/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('prodmgmt/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/prodmgmt/admin/about.php');
		$this->authenticate();
		return $this->assertContains('prodmgmt/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('prodmgmtwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modProdMgmt_ProdMgmtTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modProdMgmt_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
